...
<dialog id="modal12" class="modal">
    ...
    <button id="openModal13" class="btn btn-primary modalbtn">Adicionar Gestor</button>
    <button id="openModal12" class="btn btn-tertiary modalbtn">Remover Gestor</button>
